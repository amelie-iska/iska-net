...
| `ugm_multimodal_synthetic` | Project-generated | Synthetic phase-2 graph-to-graph examples for text, protein, SELFIES, DNA/RNA, atom/bond, temperature, coordinate, energy, and force records. | 32 generated rows in current processed corpus. | Generated, then curated split currently train 23, validation 5, test 4. |
