...
The coordinate and frame decoder is autoregressive. It emits candidate atom, bond, coordinate, and frame records as ordinary output graph tokens rather than through a separate continuous coordinate head. In the implementation, a bounded generated position record has the form
\[
