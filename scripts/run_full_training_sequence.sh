...
export FULL_TRAIN_EPOCHS FULL_TRAIN_BATCH_SIZE FULL_TRAIN_EVAL_BATCH_SIZE FULL_TRAIN_GRAD_ACCUM
...
log "FULL_TRAIN_BATCH_SIZE=${FULL_TRAIN_BATCH_SIZE:-config-default} FULL_TRAIN_EVAL_BATCH_SIZE=${FULL_TRAIN_EVAL_BATCH_SIZE:-config/default} FULL_TRAIN_GRAD_ACCUM=${FULL_TRAIN_GRAD_ACCUM:-config-default}"
