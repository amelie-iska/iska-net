...
REQUIRED_FILES = [
    ...
    "config/train/overrides/uma_coordinate_head.yaml",
    "config/train/overrides/uma_internal_coordinates.yaml",
    "src/iska_reasoner/data/bioselfies.py",
    ...
    "config/train/gflownet_sft_tiny.yaml",
    "config/train/gflownet_sft_4090.yaml",
    "config/train/structure_dynamics_gflownet_tiny.yaml",
    "config/train/structure_dynamics_gflownet_4090.yaml",
    "config/validate/gflownet_sft_4090_validation.yaml",
    "config/validate/structure_dynamics_gflownet_4090_validation.yaml",
    ...
    "config/validate/biomed_annotations_affinity_gflownet_sft_validation.yaml",
    "config/validate/biomed_annotations_affinity_structure_dynamics_gflownet_validation.yaml",
    ...
    "planning/BIOMOLECULAR-ORACLE-DYNAMICS-PLAN.md",
    "planning/ORACLE-DYNAMICS-TRAINING-RUNBOOK.md",
    "planning/MULTIMODAL-BIO-LM-DATASET-UTILIZATION-PLAN.md",
...
REQUIRED_VOCAB_TOKENS = [
    ...
    "FORCE:dir:px",
    "UMA_COORD_QUERY:C",
    "INTERNAL_COORD_QUERY:protein_phi",
